    ...
    Route::prefix('bell')->name('bell.')
        ...
        ->group(function () {
            ...
            Route::post('trigger-recipients/{trigger_recipient}/restore',
                [\Fintech\Bell\Http\Controllers\TriggerRecipientController::class, 'restore'])
            ...
            Route::post('trigger-variables/{trigger_variable}/restore',
                [\Fintech\Bell\Http\Controllers\TriggerVariableController::class, 'restore'])
            ...
            Route::post('notification-templates/{notification_template}/restore',
                [\Fintech\Bell\Http\Controllers\NotificationTemplateController::class, 'restore'])
            ...
            Route::post('trigger-actions/{trigger_action}/restore',
                [\Fintech\Bell\Http\Controllers\TriggerActionController::class, 'restore'])
